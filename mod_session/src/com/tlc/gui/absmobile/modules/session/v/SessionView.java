...
public final class SessionView extends NormalView {

	public SessionView(UISession m) {
		super(m);
	}
	...
	public String render() {
		...
		UISession u = (UISession) this.data;
		//if(u.getToken()!=null)ret.put("token", u.getToken().toString());
