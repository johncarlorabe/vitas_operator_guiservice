	...
	public boolean start() {
		...
		if(started){
			...
			if(vUserId.getValue()!=null){
				...
				this.setGui((String)this.db.QueryScalar("SELECT ACCOUNTNUMBER FROM ADMDBMC.TBLACCOUNTINFO WHERE ID = ?", "", new Object[] { this.db.QueryScalar("SELECT ROOT FROM ADMDBMC.TBLACCOUNTINFO WHERE ACCOUNTNUMBER = ?", "", new Object[] { rr.getString("ACCOUNTNUMBER") }) }));
