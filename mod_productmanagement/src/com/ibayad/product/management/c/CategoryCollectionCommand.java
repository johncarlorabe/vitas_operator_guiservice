...
import com.ibayad.product.management.m.CategoryCollection;
...
public class CategoryCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				CategoryCollection model = new CategoryCollection();
