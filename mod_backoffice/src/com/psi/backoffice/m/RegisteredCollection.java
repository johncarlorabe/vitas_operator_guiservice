...
public class RegisteredCollection extends ModelCollection{
	...
	public boolean hasRows() {
	     ...
	     DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLUSERS WHERE ACCOUNTNUMBER =? AND USERSLEVEL NOT IN ( 'ADMIN OPERATOR','CASHIER','MANAGER','KEYACCOUNT','CUSTOMER')", this.id);
