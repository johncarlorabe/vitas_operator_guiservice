...
import com.psi.reports.m.DailyBillsPaymentCollection;
...
public class DailyBillsPaymentColCommand extends UICommand{
	...
	public IView execute() {
		...
		DailyBillsPaymentCollection model = new DailyBillsPaymentCollection();
						model.setId(linkId);
	...
	public String getKey() {
		return "OUTLETDAILYBILLSPAYMENT";
	}
