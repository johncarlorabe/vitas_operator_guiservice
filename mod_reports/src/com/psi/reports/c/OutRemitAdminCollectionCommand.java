...
import com.psi.reports.m.AdminOutRemitCollection;
...
public class OutRemitAdminCollectionCommand extends UICommand{
	...
	public IView execute() {
		ExistingSession sess = null;
				...
				AdminOutRemitCollection model = new AdminOutRemitCollection();
	...
	public String getKey() {
		...
		return "OUTREMITADMINCOLLECTION";
	}
