...
public class VoidedTransactionsAdminColCommand extends UICommand{
	...
	public IView execute() {
		...
		AdminVoidedTransactionHistoryCollection model = new AdminVoidedTransactionHistoryCollection();
	...
	public String getKey() {
		...
		return "VOIDEDTRANSACTIONHISTORY";
	}
