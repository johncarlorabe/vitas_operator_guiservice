...
public class BillsPaymentAdminColCommand extends UICommand{
	...
	public IView execute() {
		ExistingSession sess = null;
				...
				AdminBillsPaymentCollection model = new AdminBillsPaymentCollection();
