...
public class PrepaidTransAdminColCommand extends UICommand{
	...
	public IView execute() {
		ExistingSession sess = null;
				...
				AdminPrepaidTransCollection model = new AdminPrepaidTransCollection();
