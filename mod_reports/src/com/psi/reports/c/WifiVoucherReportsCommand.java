...
import com.psi.reports.m.WifiVoucherHistoryCollection;
...
public class WifiVoucherReportsCommand extends UICommand{
	...
	public IView execute() {
		...
		WifiVoucherHistoryCollection model = new WifiVoucherHistoryCollection();
						model.setId(linkId);
	...
	public String getKey() {
		...
		return "WIFIVOUCHERSTRANSACTIONS";
	}
