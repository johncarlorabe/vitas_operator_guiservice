...
import com.psi.reports.m.OutRemitCollection;
...
public class OutRemitCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		OutRemitCollection model = new OutRemitCollection();
						model.setId(linkId);
