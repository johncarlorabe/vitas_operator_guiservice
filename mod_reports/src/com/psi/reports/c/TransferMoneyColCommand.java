...
import com.psi.reports.m.TransferMoneyCollection;
...
public class TransferMoneyColCommand
  extends UICommand
{
  public IView execute() {
    ...
    try {
      ...
      if (sess.exists()) {
        ...
        TransferMoneyCollection model = new TransferMoneyCollection();
  ...
  public String getKey() { return "TRANSFERMONEYHISTORY"; }



  
  public int getId() { return 3126; }
}
