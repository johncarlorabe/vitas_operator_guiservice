...
import com.psi.reports.v2.m.ServicesCollection;
...
public class ServicesColCommand extends UICommand{
	...
	public IView execute() {
		...
		ServicesCollection model = new ServicesCollection();
				...
				if(code.equals("ALL") && service.equals("ALL")){
					if(model.hasRows()){
				...
				}else if(!code.equals("ALL") && service.equals("ALL")){
