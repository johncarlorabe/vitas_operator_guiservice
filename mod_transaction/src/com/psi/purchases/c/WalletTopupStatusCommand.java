...
import com.psi.purchases.m.WalletTopupStatusCollection;
...
public class WalletTopupStatusCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				WalletTopupStatusCollection topup = new WalletTopupStatusCollection();
				topup.setId(id);
	...
	public String getKey() {
		...
		return "WALLETTOPUPCOLLECTIONTRACKING";
	}
