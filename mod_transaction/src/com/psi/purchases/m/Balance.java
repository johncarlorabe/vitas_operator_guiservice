...
public class Balance extends Model {
	...
	public boolean balance(String id) throws ParseException, Exception {
		OtherProperties prop = new OtherProperties();
		
		DataRow res = SystemInfo.getDb().QueryDataRow("SELECT * FROM TBLUSERS WHERE USERID=?", id);
	...
	public boolean balanceAccountNumber(String accountnumber) throws ParseException, Exception {
		OtherProperties prop = new OtherProperties();
